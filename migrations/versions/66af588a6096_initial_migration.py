...
Revision ID: 66af588a6096
Revises: 
Create Date: 2022-07-24 01:04:50.939040
...
def upgrade():
    ...
    sa.Column('role', sa.Enum('complainer', 'approver', 'admin', name='userrolemodel'), nullable=False),
    ...
    sa.Column('status', sa.Enum('pending', 'approved', 'rejected', name='complaintstatusmodel'), nullable=False),
